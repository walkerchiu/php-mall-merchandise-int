...
class ProductObserver
{
    ...
    public function saving($entity)
    {
        if (
            ...
            && config('wk-core.class.mall-merchandise.product')
                ::where('id', '<>', $entity->id)
    ...
    public function deleted($entity)
    {
        if ($entity->isForceDeleting()) {
            ...
            $records = $entity->variants()->withTrashed()->get();
            ...
            if (
                ...
                foreach ($entity->variants()->withTrashed() as $variant) {
                    $records = $variant->images()->withTrashed()->get();
                    foreach ($records as $recoed) {
                        $recoed->forceDelete();
                    }
                    $variant->forceDelete();
